// frontend/app/models/model1/metrics/page.js
import Link from 'next/link';
import { FaChartBar, FaChartLine, FaChartPie, FaArrowLeft } from 'react-icons/fa';

export default function Model1MetricsPage() {
  return (
    <div className="flex min-h-screen bg-black">
      ...
      <div className="flex-1 py-12 px-8">
        ...
        <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 shadow-xl mb-8">
          ...
          <div className="space-y-6">
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-white mb-2">Root Mean Squared Error (RMSE): €91,468.46</h3>
            ...
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-white mb-2">Mean Absolute Error (MAE): €69,956.68</h3>
              <p className="text-gray-300 mb-2">
            ...
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-white mb-2">Mean Absolute Percentage Error (MAPE): 20.15%</h3>
              <p className="text-gray-300 mb-2">
            ...
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-white mb-2">R² Score (Coefficient of Determination): 0.8513</h3>
              <p className="text-gray-300 mb-2">
        ...
        <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 shadow-xl mb-8">
          ...
          <div className="space-y-6">
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-white mb-2">Cross-validated R² Score: 0.9057 ± 0.0538</h3>
              <p className="text-gray-300 mb-2">
                The model explains approximately 90.6% of the variance in housing prices across the validation folds, with moderate consistency.
              </p>
            </div>
            
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-white mb-2">Cross-validated RMSE: €100,599.77 ± €26,085.30</h3>
              <p className="text-gray-300 mb-2">
                The average root mean squared error across all validation folds, with a relatively high standard deviation indicating some variability in performance.
              </p>
            </div>
            
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-white mb-2">Cross-validated MAE: €71,738.83 ± €14,711.99</h3>
              <p className="text-gray-300 mb-2">
                The average mean absolute error across all validation folds, showing a similar pattern of prediction accuracy with moderate variability.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 shadow-xl">
          ...
          <p className="text-gray-300 mb-6">
            To ensure robust evaluation and avoid overfitting, our Linear Regression model was evaluated using k-fold cross-validation with the following approach:
          </p>
