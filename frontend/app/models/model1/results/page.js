// frontend/app/models/model1/results/page.js
import Link from 'next/link';
import { FaChartBar, FaChartLine, FaChartPie, FaArrowLeft } from 'react-icons/fa';

export default function Model1ResultsPage() {
  return (
      ...
      <div className="flex-1 py-12 px-8">
        ...
        <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 shadow-xl mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-gray-800 p-5 rounded-lg border border-gray-700 text-center">
              ...
              <p className="text-3xl font-bold text-blue-400">€69,957</p>
          ...
          <div className="space-y-4">
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                <span className="text-blue-400">€69,957</span>
              </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                <span className="text-blue-400">€91,468</span>
              </div>
              <div className="w-full bg-gray-700 rounded-full h-2.5">
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                <span className="text-blue-400">0.8513</span>
              </div>
              <div className="w-full bg-gray-700 rounded-full h-2.5">
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                <span className="text-blue-400">20.15%</span>
              </div>
              <div className="w-full bg-gray-700 rounded-full h-2.5">
        ...
        <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 shadow-xl mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div className="bg-gray-800 p-5 rounded-lg border border-gray-700 text-center">
              ...
              <p className="text-3xl font-bold text-blue-400">€100,600</p>
              <p className="text-sm text-gray-400 mt-2">± €26,085</p>
            </div>
            
            <div className="bg-gray-800 p-5 rounded-lg border border-gray-700 text-center">
              <h3 className="text-lg font-semibold text-white mb-2">CV R² Score</h3>
              <p className="text-3xl font-bold text-blue-400">0.9057</p>
              <p className="text-sm text-gray-400 mt-2">± 0.0538</p>
            </div>
            
            <div className="bg-gray-800 p-5 rounded-lg border border-gray-700 text-center">
              <h3 className="text-lg font-semibold text-white mb-2">CV MAE</h3>
              <p className="text-3xl font-bold text-blue-400">€71,739</p>
              <p className="text-sm text-gray-400 mt-2">± €14,712</p>
            </div>
          </div>
          
          <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
            <p className="text-gray-300 text-sm">
              <strong className="text-blue-400">Note:</strong> Cross-validation was performed using 5 folds, with results showing means and standard deviations across all folds. The CV R² score of 0.9057 indicates good generalization capabilities.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 shadow-xl">
          ...
          <p className="text-gray-300 mb-6">
            Comparing our Linear Regression model against other models based on key performance metrics:
          </p>
            ...
            <table className="w-full text-sm text-left text-gray-400 rounded-lg overflow-hidden">
              ...
              <tbody>
                ...
                <tr className="bg-gray-800 border-2 border-blue-900">
                  <th scope="row" className="px-6 py-4 font-medium text-blue-400">Linear</th>
          ...
          <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
            <p className="text-gray-300 text-sm">
              <strong className="text-blue-400">Prediction Behavior:</strong> In our most recent prediction run, the Linear model predicted a value of €101,684,946.24, which was significantly higher than other models and excluded from the ensemble average. This suggests the Linear model may tend to overestimate prices for certain property types.
            </p>
          </div>
        </div>
      </div>
