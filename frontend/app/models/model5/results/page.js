// frontend/app/models/model5/results/page.js
import Link from 'next/link';
import { FaChartBar, FaChartLine, FaChartPie, FaArrowLeft } from 'react-icons/fa';

export default function Model5ResultsPage() {
  return (
      ...
      <div className="flex-1 py-12 px-8">
        ...
        <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 shadow-xl mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-gray-800 p-5 rounded-lg border border-gray-700 text-center">
              ...
              <p className="text-3xl font-bold text-blue-400">€67,822</p>
          ...
          <div className="space-y-4">
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                <span className="text-blue-400">€67,822</span>
              </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                <span className="text-blue-400">€89,590</span>
              </div>
              <div className="w-full bg-gray-700 rounded-full h-2.5">
                <div className="bg-blue-400 h-2.5 rounded-full" style={{ width: '70%' }}></div>
              </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                <span className="text-blue-400">0.8574</span>
              </div>
              <div className="w-full bg-gray-700 rounded-full h-2.5">
                <div className="bg-blue-400 h-2.5 rounded-full" style={{ width: '86%' }}></div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="w-full bg-gray-700 rounded-full h-2.5">
                <div className="bg-blue-400 h-2.5 rounded-full" style={{ width: '65%' }}></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 shadow-xl mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div className="bg-gray-800 p-5 rounded-lg border border-gray-700 text-center">
              ...
              <p className="text-3xl font-bold text-blue-400">€90,526</p>
              <p className="text-sm text-gray-400 mt-2">± €22,765</p>
            </div>
            
            <div className="bg-gray-800 p-5 rounded-lg border border-gray-700 text-center">
              <h3 className="text-lg font-semibold text-white mb-2">CV R² Score</h3>
              <p className="text-3xl font-bold text-blue-400">0.9226</p>
              <p className="text-sm text-gray-400 mt-2">± 0.0468</p>
            </div>
            
            <div className="bg-gray-800 p-5 rounded-lg border border-gray-700 text-center">
              <h3 className="text-lg font-semibold text-white mb-2">CV MAE</h3>
              <p className="text-3xl font-bold text-blue-400">€66,176</p>
              <p className="text-sm text-gray-400 mt-2">± €12,635</p>
            </div>
          </div>
          
          <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
            <p className="text-gray-300 text-sm">
              <strong className="text-blue-400">Note:</strong> Cross-validation was performed using 5 folds, with results showing means and standard deviations across all folds. The relatively low standard deviation in cross-validation metrics suggests good stability across different data subsets.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 shadow-xl">
          ...
          <p className="text-gray-300 mb-6">
            Comparing our Ridge Regression model against other models based on key performance metrics:
          </p>
          ...
          <div className="overflow-x-auto mb-6">
            <table className="w-full text-sm text-left text-gray-400 rounded-lg overflow-hidden">
              ...
              <tbody>
                ...
                <tr className="bg-gray-700 border-2 border-blue-900">
                  <th scope="row" className="px-6 py-4 font-medium text-blue-400">Ridge</th>
          ...
          <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
            <p className="text-gray-300 text-sm">
              <strong className="text-blue-400">Prediction Behavior:</strong> In our most recent prediction run, the Ridge model predicted a value of €432,850.17, which is within a reasonable range compared to other models. The Ridge model consistently ranks in the middle of our model comparison, offering a good balance between model complexity and prediction accuracy.
            </p>
          </div>
        </div>
      </div>
