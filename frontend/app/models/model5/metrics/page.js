// frontend/app/models/model5/metrics/page.js
import Link from 'next/link';
import { FaChartBar, FaChartLine, FaChartPie, FaArrowLeft } from 'react-icons/fa';

export default function Model5MetricsPage() {
  return (
    <div className="flex min-h-screen bg-black">
      ...
      <div className="flex-1 py-12 px-8">
        ...
        <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 shadow-xl mb-8">
          ...
          <div className="space-y-6">
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-white mb-2">Root Mean Squared Error (RMSE): €89,589.65</h3>
            ...
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-white mb-2">Mean Absolute Error (MAE): €67,822.40</h3>
              <p className="text-gray-300 mb-2">
            ...
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-white mb-2">Mean Absolute Percentage Error (MAPE): 18.00%</h3>
              <p className="text-gray-300 mb-2">
            ...
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-white mb-2">R² Score (Coefficient of Determination): 0.8574</h3>
              <p className="text-gray-300 mb-2">
        ...
        <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 shadow-xl mb-8">
          ...
          <div className="space-y-6">
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-white mb-2">Cross-validated R² Score: 0.9226 ± 0.0468</h3>
              <p className="text-gray-300 mb-2">
                The model explains approximately 92.3% of the variance in housing prices across the validation folds, with good consistency.
              </p>
            </div>
            
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-white mb-2">Cross-validated RMSE: €90,525.77 ± €22,764.58</h3>
              <p className="text-gray-300 mb-2">
                The average root mean squared error across all validation folds, with a moderate standard deviation indicating reasonably consistent performance.
              </p>
            </div>
            
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-white mb-2">Cross-validated MAE: €66,175.76 ± €12,635.42</h3>
              <p className="text-gray-300 mb-2">
                The average mean absolute error across all validation folds, showing consistent prediction accuracy with relatively low variability.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 shadow-xl">
          ...
          <p className="text-gray-300 mb-6">
            To ensure robust evaluation and avoid overfitting, our Ridge Regression model was evaluated using k-fold cross-validation with the following approach:
          </p>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-300">Grid search was used to find the optimal regularization strength (alpha = 10.0)</p>
              </div>
            </div>
          ...
          <div className="mt-6 p-4 bg-gray-800 rounded-lg border border-gray-700">
            <p className="text-gray-300 text-sm">
              <strong className="text-blue-400">Note:</strong> The difference between cross-validation R² (0.9226) and test set R² (0.8574) indicates some degree of overfitting, though less pronounced than in other models. The relatively low standard deviation in cross-validation metrics suggests good stability across different data subsets.
            </p>
          </div>
        </div>
      </div>
