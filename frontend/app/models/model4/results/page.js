// frontend/app/models/model4/results/page.js
import Link from 'next/link';
import { FaChartBar, FaChartLine, FaChartPie, FaArrowLeft } from 'react-icons/fa';

export default function Model4ResultsPage() {
  return (
      ...
      <div className="flex-1 py-12 px-8">
        ...
        <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 shadow-xl mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-gray-800 p-5 rounded-lg border border-gray-700 text-center">
              ...
              <p className="text-3xl font-bold text-blue-400">€74,247</p>
          ...
          <div className="space-y-4">
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                <span className="text-blue-400">€74,247</span>
              </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                <span className="text-blue-400">€95,102</span>
              </div>
              <div className="w-full bg-gray-700 rounded-full h-2.5">
                <div className="bg-blue-400 h-2.5 rounded-full" style={{ width: '58%' }}></div>
              </div>
            </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                <span className="text-blue-400">0.8393</span>
              </div>
              <div className="w-full bg-gray-700 rounded-full h-2.5">
                <div className="bg-blue-400 h-2.5 rounded-full" style={{ width: '84%' }}></div>
              </div>
            </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-1">
                ...
                <span className="text-blue-400">19.24%</span>
              </div>
              <div className="w-full bg-gray-700 rounded-full h-2.5">
                <div className="bg-blue-400 h-2.5 rounded-full" style={{ width: '62%' }}></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 shadow-xl mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div className="bg-gray-800 p-5 rounded-lg border border-gray-700 text-center">
              ...
              <p className="text-3xl font-bold text-blue-400">€131,124</p>
              <p className="text-sm text-gray-400 mt-2">± €21,209</p>
            </div>
            
            <div className="bg-gray-800 p-5 rounded-lg border border-gray-700 text-center">
              <h3 className="text-lg font-semibold text-white mb-2">CV R² Score</h3>
              <p className="text-3xl font-bold text-blue-400">0.8462</p>
              <p className="text-sm text-gray-400 mt-2">± 0.0464</p>
            </div>
            
            <div className="bg-gray-800 p-5 rounded-lg border border-gray-700 text-center">
              <h3 className="text-lg font-semibold text-white mb-2">CV MAE</h3>
              <p className="text-3xl font-bold text-blue-400">€96,586</p>
              <p className="text-sm text-gray-400 mt-2">± €16,516</p>
            </div>
          </div>
          
          <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
            <p className="text-gray-300 text-sm">
              <strong className="text-blue-400">Note:</strong> Cross-validation was performed using 5 folds. The SVR model showed the highest cross-validation RMSE and MAE among all models, though there was moderate consistency across folds as indicated by the standard deviations.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 shadow-xl">
          ...
          <p className="text-gray-300 mb-6">
            Comparing our SVR model against other models based on key performance metrics:
          </p>
            ...
            <table className="w-full text-sm text-left text-gray-400 rounded-lg overflow-hidden">
              ...
              <tbody>
                ...
                <tr className="bg-gray-800">
                  <th scope="row" className="px-6 py-4 font-medium text-white">Lasso</th>
                ...
                <tr className="bg-gray-800 border-2 border-blue-900">
                  <th scope="row" className="px-6 py-4 font-medium text-blue-400">SVR</th>
          ...
          <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
            <p className="text-gray-300 text-sm">
              <strong className="text-blue-400">Prediction Behavior:</strong> In our most recent prediction run, the SVR model predicted a value of €342,477.41, which is within a reasonable range compared to other models. Despite ranking 6th overall, this model still contributes valuable insights to the ensemble prediction approach and performs well on specific types of properties.
            </p>
          </div>
        </div>
      </div>
