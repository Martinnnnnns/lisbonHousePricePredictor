// frontend/app/models/model6/metrics/page.js
import Link from 'next/link';
import { FaChartBar, FaChartLine, FaChartPie, FaArrowLeft } from 'react-icons/fa';

export default function Model6MetricsPage() {
  return (
      ...
      <div className="flex-1 py-12 px-8">
        ...
        <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 shadow-xl mb-8">
          ...
          <p className="text-gray-300 mb-6">
            The following metrics have been used to evaluate our Lasso Regression model&apos;s performance in predicting Lisbon house prices:
          </p>
          
          <div className="space-y-6">
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-white mb-2">Root Mean Squared Error (RMSE): €86,767.18</h3>
            ...
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-white mb-2">Mean Absolute Error (MAE): €63,861.02</h3>
              <p className="text-gray-300 mb-2">
            ...
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-white mb-2">Mean Absolute Percentage Error (MAPE): 17.35%</h3>
              <p className="text-gray-300 mb-2">
            ...
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-white mb-2">R² Score (Coefficient of Determination): 0.8662</h3>
              <p className="text-gray-300 mb-2">
        ...
        <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 shadow-xl mb-8">
          ...
          <div className="space-y-6">
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-white mb-2">Cross-validated R² Score: 0.8945 ± 0.0624</h3>
              <p className="text-gray-300 mb-2">
                The model explains approximately 89.5% of the variance in housing prices across the validation folds, with good consistency.
              </p>
            </div>
            
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-white mb-2">Cross-validated RMSE: €101,283.46 ± €28,654.72</h3>
              <p className="text-gray-300 mb-2">
                The average root mean squared error across all validation folds, with moderate variability in performance.
              </p>
            </div>
            
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-white mb-2">Cross-validated MAE: €72,164.51 ± €15,840.33</h3>
              <p className="text-gray-300 mb-2">
                The average mean absolute error across all validation folds, showing consistent prediction accuracy.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 shadow-xl">
          ...
          <p className="text-gray-300 mb-6">
            To ensure robust evaluation and avoid overfitting, our Lasso Regression model was evaluated using k-fold cross-validation with the following approach:
          </p>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-300">Grid search was used to find the optimal alpha value (regularization strength) of 0.1</p>
              </div>
            </div>
          ...
          <div className="mt-6 p-4 bg-gray-800 rounded-lg border border-gray-700">
            <p className="text-gray-300 text-sm">
              <strong className="text-blue-400">Note:</strong> The difference between cross-validation R² (0.8945) and test set R² (0.8662) suggests good generalization, with only a moderate drop in performance on completely new data. The Lasso model&apos;s feature selection capabilities help prevent overfitting.
            </p>
          </div>
        </div>
      </div>
