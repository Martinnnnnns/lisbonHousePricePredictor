// frontend/app/models/model3/metrics/page.js
import Link from 'next/link';
import { FaChartBar, FaChartLine, FaChartPie, FaArrowLeft } from 'react-icons/fa';

export default function Model3MetricsPage() {
  return (
      ...
      <div className="flex-1 py-12 px-8">
        ...
        <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 shadow-xl mb-8">
          ...
          <p className="text-gray-300 mb-6">
            The following metrics have been used to evaluate our Random Forest model&apos;s performance in predicting Lisbon house prices:
          </p>
          
          <div className="space-y-6">
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-white mb-2">Root Mean Squared Error (RMSE): €66,085.23</h3>
            ...
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-white mb-2">Mean Absolute Error (MAE): €38,728.27</h3>
              <p className="text-gray-300 mb-2">
            ...
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-white mb-2">Mean Absolute Percentage Error (MAPE): 10.99%</h3>
              <p className="text-gray-300 mb-2">
            ...
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-white mb-2">R² Score (Coefficient of Determination): 0.9224</h3>
              <p className="text-gray-300 mb-2">
        ...
        <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 shadow-xl mb-8">
          ...
          <div className="space-y-6">
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-white mb-2">Cross-validated R² Score: 0.9005 ± 0.0828</h3>
              <p className="text-gray-300 mb-2">
                The model explains approximately 90.1% of the variance in housing prices across the validation folds, with moderate consistency.
              </p>
            </div>
            
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-white mb-2">Cross-validated RMSE: €99,207.24 ± €36,955.91</h3>
              <p className="text-gray-300 mb-2">
            ...
            <div className="p-4 bg-gray-800 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-white mb-2">Cross-validated MAE: €63,064.59 ± €16,984.11</h3>
              <p className="text-gray-300 mb-2">
        ...
        <div className="bg-gray-900 p-8 rounded-xl border border-gray-800 shadow-xl">
          ...
          <p className="text-gray-300 mb-6">
            To ensure robust evaluation and avoid overfitting, our Random Forest model was evaluated using k-fold cross-validation with the following approach:
          </p>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-300">Grid search was used to find optimal hyperparameters: n_estimators=50, max_depth=None, min_samples_split=2</p>
              </div>
            </div>
          ...
          <div className="mt-6 p-4 bg-gray-800 rounded-lg border border-gray-700">
            <p className="text-gray-300 text-sm">
              <strong className="text-blue-400">Note:</strong> The final test set performance (R² = 0.9224) was even better than the cross-validation results (R² = 0.9005 ± 0.0828), indicating excellent generalization to new data and suggesting the model is not overfitting.
            </p>
          </div>
        </div>
      </div>
